...
-- Sun 25 Mar 2018 02:59:57 PM CDT
...
-- -----------------------------------------------------
-- Table `DB_Lab`.`accounts`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `DB_Lab`.`accounts` (
...
CREATE TABLE IF NOT EXISTS `DB_Lab`.`candidates` (
  ...
  PRIMARY KEY (`accountId`, `electionId`),
  INDEX `electionId_idx` (`electionId` ASC),
  CONSTRAINT `accountId`
    FOREIGN KEY (`accountId`)
    REFERENCES `DB_Lab`.`accounts` (`accountId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
